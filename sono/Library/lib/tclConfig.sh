...
# installed.
TCL_PREFIX='D:/Multi-Agents-System-from-Scratch/sono\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Multi-Agents-System-from-Scratch/sono\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Multi-Agents-System-from-Scratch/sono\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Multi-Agents-System-from-Scratch/sono\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Multi-Agents-System-from-Scratch/sono\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Multi-Agents-System-from-Scratch/sono\Library\lib\tclstub86.lib'
